...
public class FFmpegTest {
    ...
    public FFmpegTest(String inputPath,String outputPath){
...
//            String currPath = diretory.getAbsolutePath();
            inputPath = "D:\\ab\\output\\output.avi";
            outputPath = "D:\\ab\\output\\";
            ffmpegPath = "D:\\ab\\ffmpeg\\ffmpeg\\";
//            System.out.println(currPath);
    ...
    private  String processAVI(int type) {
        ...
        commend.add("mp4");
        commend.add("-o");
        commend.add(outputPath + "output.AVI");
        try {
